...
func request_Testapi_Getdetails_0(ctx context.Context, marshaler runtime.Marshaler, client TestapiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Testapi_Getdetails_0(ctx context.Context, marshaler runtime.Marshaler, server TestapiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UserRequest
	var metadata runtime.ServerMetadata
...
func RegisterTestapiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TestapiServer) error {
	...
	mux.Handle("POST", pattern_Testapi_Getdetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/main.Testapi/Getdetails", runtime.WithHTTPPathPattern("/getdetails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Testapi_Getdetails_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Testapi_Getdetails_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTestapiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TestapiClient) error {
	...
	mux.Handle("POST", pattern_Testapi_Getdetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/main.Testapi/Getdetails", runtime.WithHTTPPathPattern("/getdetails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Testapi_Getdetails_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Testapi_Getdetails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"getdetails"}, ""))
)

var (
	forward_Testapi_Getdetails_0 = runtime.ForwardResponseMessage
)
